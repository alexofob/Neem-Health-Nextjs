...
exports.default = (0, _mobxReact.observer)(function (_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'b',
        { className: (0, _glamor.merge)(_Header2.default.hli, !store.tools.heading.name && _2.default.hidden) },
        'MOBX-REACT-FORM'
      ),
      _react2.default.createElement(
        'b',
        { className: (0, _glamor.merge)(_Header2.default.hlb, !store.tools.heading.sub && _2.default.hidden) },
        'DEVTOOLS'
      )
    ),
    _react2.default.createElement(
