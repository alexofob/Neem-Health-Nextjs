...
exports.default = function (_ref) {
  ...
  var getExpressionText = function getExpressionText(expr) {
    ...
    var modified = replacements.reduce(function (source, currentReplacement) {
      source = source.replace(currentReplacement.initial, currentReplacement.replacement);
      return source;
    }, source);
  ...
  return {
    ...
    visitor: {
        ...
        exit: function exit(path, state) {
          ...
          if (css.modified) {
            transformedCss = css.replacements.reduce(function (transformedCss, currentReplacement) {
              transformedCss = transformedCss.replace(currentReplacement.replacement, currentReplacement.initial);
      ...
      Program: {
        ...
        exit: function exit(_ref7, state) {
          var node = _ref7.node,
              scope = _ref7.scope;
