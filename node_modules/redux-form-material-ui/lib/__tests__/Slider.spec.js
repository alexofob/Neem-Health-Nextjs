...
describe('Slider', function () {
  ...
  it('renders a Slider with no warning when not touched', function () {
    (0, _expect2.default)(new _Slider4.default({
      input: {
        name: 'mySlider',
        value: 0.5,
  ...
  it('renders a Slider with an warning', function () {
    (0, _expect2.default)(new _Slider4.default({
      input: {
        name: 'mySlider',
        value: 0.5,
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_Slider2.default, { name: 'mySlider', value: 0.5, error: 'FooWarning', onChange: _lodash2.default,
      ref: 'component' }));
  });
  ...
  it('maps onChange properly', function () {
    ...
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      ...
      _react2.default.createElement(_Slider4.default, { name: 'mySlider', input: { onChange: onChange, value: 0.5 } })
    ));
